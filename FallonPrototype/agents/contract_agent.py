...
def build_contract_query(question: str) -> str:
    ...
    topic_keywords = {
        ...
        # Market topics
        "boston": "boston seaport south boston fanpier back bay financial district kendall square suffolk downs massachusetts market rent cap rate life sciences lab",
        "charlotte": "charlotte south end uptown noda north davidson plaza midwood south park ballantyne university city north carolina market rent cap rate blue line",
        "nashville": "nashville gulch sobro east bank germantown wedgewood houston 12 south music row downtown tennessee market rent cap rate hotel oracle",
        ...
        "lab": "lab life sciences biotech wet lab kendall square nnn rent tenant",
        "market": "market conditions trends outlook supply demand absorption",
        # Submarket topics
        "seaport": "boston seaport south boston waterfront fanpier development submarket",
        "back bay": "boston back bay copley prudential office submarket",
        "kendall": "boston kendall square cambridge life sciences lab biotech submarket",
        "south end": "south end submarket development residential",
        "uptown": "charlotte uptown downtown central business district office submarket",
        "noda": "charlotte noda north davidson arts district submarket",
        "gulch": "nashville gulch development mixed-use submarket",
        "sobro": "nashville sobro south broadway convention center submarket",
        "east bank": "nashville east bank oracle titans stadium development submarket",
        "submarket": "submarket neighborhood district micro-market location",
        "investment thesis": "investment thesis buy hold sell strategy cycle positioning",
        "zoning": "zoning regulatory IDP UDO PILOT TIF affordable housing entitlement",
        "infrastructure": "infrastructure transit blue line MBTA silver line mega-project catalyst",
    }

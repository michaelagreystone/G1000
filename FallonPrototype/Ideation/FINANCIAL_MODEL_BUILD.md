...
- [x] **1.1.1 — Define the full variable set per program type**
...
- [x] **1.1.2 — Build `market_defaults.json`**
...
- [x] **1.1.3 — Add a `last_updated` and `data_quality` field to each market block**
...
- [x] **1.1.4 — Write a validation script for the JSON**
...
- [x] **1.2.1 — Create sample deal data files**
